...
/**
 * The Panel containing the delivery request parameters (the courrier and the time window).
 */
public class DeliveryRequestView extends JPanel {

    public final static String ADD_DELIVERY_REQUEST = "Add a Delivery Request";
    /**
     * the combobox for choosing the time window
     */
    public JComboBox<TimeWindow> comboBoxTimeWindow;
    /**
     * the combobox for choosing the courier
     */
    ...
    /**
     * Updates the number of couriers in the combobox.
     */
